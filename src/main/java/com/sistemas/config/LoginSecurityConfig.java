...
public class LoginSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder authenticationMgr) throws Exception {
        authenticationMgr.inMemoryAuthentication()
                .withUser("vilcherres").password("{noop}vilches").authorities("ALUMNA")
                .and()
                .withUser("oscar").password("{noop}elpapi").authorities("ALUMNO")
                .and()
                .withUser("junior").password("{noop}chuto").authorities("ALUMNO")
                .and()
                .withUser("camilo").password("{noop}123").authorities("DIRECTOR");
    }
